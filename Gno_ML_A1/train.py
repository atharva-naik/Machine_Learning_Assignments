...
cprint("Accuracy of best tree = {}".format(accuracy(best_split['test'], best_tree)), r=255,b=255,g=0)
# best_tree.prune()
...
print(accuracy(best_split['val'], best_tree))
cprint("After pruning accuracy is = {}".format(accuracy(best_split['test'], best_tree)),r=150,g=240,b=30)
